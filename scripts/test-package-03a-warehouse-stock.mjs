...
const sql = readFileSync(new URL('../supabase/tests/package-03a-warehouse-stock.sql', import.meta.url), 'utf8')
...
console.log('Package 03A current warehouse stock import & canonicalization PASS.')
