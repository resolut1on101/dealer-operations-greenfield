...
const testFiles = [
  '../supabase/tests/package-03-product-domain.sql',
  '../supabase/tests/package-03-product-freshness.sql',
]

for (const testFile of testFiles) {
  const sql = readFileSync(new URL(testFile, import.meta.url), 'utf8')
...
console.log('Package 03 canonical product normalization & freshness PASS.')
